...
public class ArrayIntList extends AbstractIntCollection implements IntList {
	...
	@Override
	public void remove(int index) throws CollectionException {
		...
		else throw new CollectionException("Index finns inte i vår array: " +index);
	}

	@Override
	public int get(int index) throws CollectionException {
	...
	@Override
	public int indexOf(int n) throws CollectionException {
